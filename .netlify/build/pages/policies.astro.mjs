...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "DefaultLayout", $$DefaultLayout, { "title": "Policies" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container"><h2 class="mb-16 text-6xl">Policies</h2> </div> <div class="container"> ${renderComponent($$result2, "Accordion", $$Accordion, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "AccordionItem", $$AccordionItem, { "name": "exclusive", "title": "Editorial Independence Policy" }, { "default": ($$result4) => renderTemplate` <p>
Our organization retains full authority over our content to protect the best journalistic and business interests of our organization. Sources of all revenue will not have any impact on any of our editorial decisions or content. Acceptance of financial support does not constitute implied or actual endorsement of donors or their products, services or opinions.</p> <p>
...
</p> ` })} ${renderComponent($$result3, "AccordionItem", $$AccordionItem, { "name": "exclusive", "title": "Donor & Financial Transparency policy" }, { "default": ($$result4) => renderTemplate` <p>
...
</p> ` })} ${renderComponent($$result3, "AccordionItem", $$AccordionItem, { "name": "exclusive", "title": "Conflict of Interest Policies" }, { "default": ($$result4) => renderTemplate` <p>
...
</p><p> <b>Conflicts of Interest.</b> </p><p>
...
</p><p>(a) any real or apparent conflict of interest between a donor or the subject of an SDJ publication ,report or program and an SDJ Representative;
</p><p>(b) an SDJ Representative’s ownership of an equity interest in a person or entity that is or will be the subject of an SDJ publication,report or program; and
</p><p>(c) failure to disclose to SDJ all relationships between the subject of any SDJ publication,report or program and any SDJ Representative or close relatives of the SDJ Representative.
</p><p> <b>Conflict Procedure:</b> </p><p>
...
</p><p> <b>Personal Loans.</b> </p><p>
SDJ may not loan to, or guarantee the personal obligations of, any SDJ Representative.
</p> ` })} ` })} </div> ` })}`;
}, "/Users/databae/Documents/accessible-astro-starter-main/src/pages/policies/index.astro", void 0);

const $$file = "/Users/databae/Documents/accessible-astro-starter-main/src/pages/policies/index.astro";
const $$url = "/policies";
