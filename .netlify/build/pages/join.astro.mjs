...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "DefaultLayout", $$DefaultLayout, { "title": "Join" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container"><h2 class="mb-16 text-6xl">Join</h2> </div> <div class="container"> <p>SDJ aims to be an inclusive community and offers several different categories of paid membership. Membership fees support SDJ’s operational budget, which covers the costs of website fees, maintaining the Slack, legal fees and programs.
</p><br> <p> Benefits of becoming a member include X, Y, Z.
</p><br> <p> However, we recognize that not everyone is able to afford membership fees and have created a separate application for individuals to apply for reduced or free membership.
</p><br> <p> Not sure what type of membership fits you best? Learn more about our membership categories below.
</p><br> </div> <div class="container"> ${renderComponent($$result2, "Accordion", $$Accordion, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "AccordionItem", $$AccordionItem, { "name": "exclusive", "title": "Full Membership" }, { "default": ($$result4) => renderTemplate` <p>
...
</p> ` })} ${renderComponent($$result3, "AccordionItem", $$AccordionItem, { "name": "exclusive", "title": "Student Membership" }, { "default": ($$result4) => renderTemplate` <p>
...
</p> ` })} ${renderComponent($$result3, "AccordionItem", $$AccordionItem, { "name": "exclusive", "title": "Associate Membership" }, { "default": ($$result4) => renderTemplate` <p>
...
</p> ` })} ${renderComponent($$result3, "AccordionItem", $$AccordionItem, { "name": "exclusive", "title": "Retired Membership" }, { "default": ($$result4) => renderTemplate` <p>
...
}, "/Users/databae/Documents/accessible-astro-starter-main/src/pages/join/index.astro", void 0);

const $$file = "/Users/databae/Documents/accessible-astro-starter-main/src/pages/join/index.astro";
const $$url = "/join";
